...
import sehati.util.spring.MessageUtil;
    ...
    */
	public static String encryptSHA256UTF8(String str) throws Exception {
		...
		try {
			...
			throw new RuntimeException(MessageUtil.getMessage("COM00002001"), e);
...
//		BASE64Encoder base64 = new BASE64Encoder();
    ...
    public static boolean encryptFile(String source, String target) throws Exception {
		...
		try {
			...
			throw new RuntimeException(MessageUtil.getMessage("COM00002001"), ex);
		}
		finally {
			input.close();
			output.close();
