...
import sehati.util.base.BaseConstants;
...
//			marshaller.setProperty(Marshaller.JAXB_FRAGMENT, Boolean.TRUE);
			...
			throw new RuntimeException(MessageUtil.getMessage(BaseConstants.DEFAULT_ERROR_CODE), e);
		}
		return xmlDoc;
	}
